...
class NovaPorcelanatoScraper
{
    public static function coletar(): array
    {
        $client = new Client([
            'base_uri' => 'http://portal.novaporcelanato.com.br',
            'cookies' => true,
            'headers' => [
        ...
        // 3. Acessa os dados da planilha (URL corrigida)
        ...
        foreach ($rows as $row) {
            ...
            try {
                ...
                $pedido = [
                    ...
                    'qtd_pallets' => (int) floatval(str_replace(',', '.', $cols[15]->nodeValue)),
